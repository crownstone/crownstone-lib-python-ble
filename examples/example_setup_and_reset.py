...
# Get first Crownstone in setup mode.
...
if nearestStone is not None:
    ...
    print("Waiting until Crownstone is in normal mode and ready.")
    if core.isCrownstoneInNormalMode(nearestStone["address"], scanDuration=10, waitUntilInRequiredMode=True):
        # Eeset the Crownstone back into setup mode.
